...
1. Plugin admin page.
2. The internal linking created base on search engine user keyword.
3. Popular, Popular in Category, Recent, and Random Search Terms Widget
4. Plugin statistic page.
...
= 1.52 =
Search permalink using - instead of +; Upgrade database for better performance and to support international characters; Using cache; Promote old post with no traffic; Auto cleaned up database is mandatory; Record all the keywords, not only for single/page;