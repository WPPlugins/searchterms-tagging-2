...
define('PK_WATERMARK','<!-- SEO SearchTerms Tagging 2 Plugin -->');
...
function pk_stt2_admin_print_header(){
	...
	?>
		...
		<a href="<?php echo $baseurl.'&stats=1&count=500'; ?>">500</a></p>
    <?php
}
/*
	...
	<div class="postbox-container" style="width: 74%;">
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">    
				<div id="stt2new" class="postbox">
					<div class="handlediv" title="Click to toggle"><br /></div>
					<h3 class="hndle"><span>What's New in Version 1.5?</span></h3>
					<div class="inside">
						<div class="frame">
							<ol>
								<li>Change blog search permalink, now using - instead of + (e.g: domain.com/search/search-terms/).</li>
								<li>Upgrade database structure for better performance, lower system resources and to support international characters.</li>
								<li>Using WordPress cache object to cache common database queries.</li>
								<li>New option to promote old post that has not received traffic after 30 days in publishing.</li>
								<li>Auto cleaned up database is mandatory now, with the default setting to delete unused search terms after 90 days.</li>
								<li>Now record all the keywords, not only the one that comes to single post or page.</li>
							</ol>
						</div>
					</div>
				</div>			
						...
						<form id="stt2-options" method="post" action="">
							<table class="stt2-table">
								...
								<tr>
									...
									<td>
										<Input type="radio" name="auto_link" value="1" <?php if ( 1 == $options['auto_link'] ){ echo 'checked'; } ;?> />         Yes, link to post content&nbsp;&nbsp;
										<Input type="radio" name="auto_link" value="2" <?php if ( 2 == $options['auto_link'] ){ echo 'checked'; } ;?> />         Yes, link to search page&nbsp;&nbsp;
  ...
  <div class="metabox-holder">
       <div id="stt2-copyright" class="postbox">
        <div class="inside">
		  ...
		  <p><strong>Recommended SEO plugins: <a href="http://9cab9omg4qgd8r98wbjl1jucfe.hop.clickbank.net/?tid=stt2" target="_blank">Indexing Tool</a> | <a href="http://ed94dfjezefg9u0nhg0qgewkvu.hop.clickbank.net/?tid=stt2" target="_blank">SEOPressor</a> | <a href="http://5508coi61qlh0mco1k9jkcqk4z.hop.clickbank.net/?tid=stt2" target="_blank">WPSyndicator</a></strong></p>
		  <p>Copyright &copy; 2010 by Purwedi Kurniawan. Feel free to <a href="http://exclusivewordpress.com/contact/" target="_blank">contact me</a> if you need help with the plugin.</p> </div>
        </div>
     </div>
  </div>
</div>
...
**/
function pk_stt2_db_get_posts_wo_traffic( $count ){
...
function pk_stt2_db_get_id_post_wo_traffic(){
	...
	$sql = "SELECT `ID` FROM $wpdb->posts WHERE `post_status` = 'publish' AND `post_type` = 'post' AND ID NOT IN ( 
		SELECT post_id FROM ".$wpdb->prefix."stt2_meta ) LIMIT 1;";
...
function pk_stt2_registration_form($form_name, $submit_btn_txt='Register', $name, $email, $hide=0, $activate_again='') {
	...
	<form name="<?php echo $form_name;?>" method="post" action="http://clients.asianbrainfollowup.com/scripts/addlead.pl" <?php if($activate_again!=1){;?>onsubmit="return pk_stt2_validate_form_0()"<?php }?>>
...
function pk_stt2_register_1($form_name='frm1') {
	...
	?>
	 ...
	 <table width="620" cellpadding="10" cellspacing="1" bgcolor="#ffffff" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
	  ...
	  <tr><td>&nbsp;</td></tr>      
	  <tr><td align="left">In addition, you'll receive complimentary subscription to our Email Newsletter which will give you many tips and tricks to attract lots of visitors to your blog. Of course, you can unsubscribe any time you want.</td></tr>      
	  <tr><td>&nbsp;</td></tr>
	  <tr><td align="center"><?php pk_stt2_registration_form($form_name,'Register',$name,$email);?></td></tr>
	  <tr><td>&nbsp;</td></tr>
	  <tr><td align="left"><font size="1">Disclaimer: Your contact information will be handled with the strictest confidence and will never be sold or shared with third parties.</font></td></td></tr>
	 </table>
	 </center>	
	</div>
	<p>&nbsp;</p>
...
<li> To display random search terms:
								<p>
